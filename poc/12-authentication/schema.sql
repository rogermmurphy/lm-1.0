-- POC 12: Authentication & User Management Database Schema
...
-- Refresh Tokens Table (for direct authentication)
CREATE TABLE refresh_tokens (
    ...
    -- Check constraint to ensure expires_at is in the future
...
COMMENT ON COLUMN oauth_connections.access_token IS 'OAuth provider access token (encrypted in production)';
