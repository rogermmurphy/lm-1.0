...
-- FIXED: Changed study_notes references to study_materials
...
CREATE TABLE IF NOT EXISTS note_sources (
    ...
    note_id INTEGER NOT NULL REFERENCES study_materials(id) ON DELETE CASCADE,
...
-- Enhance existing study_materials table
ALTER TABLE study_materials ADD COLUMN IF NOT EXISTS is_ai_generated BOOLEAN DEFAULT false;
ALTER TABLE study_materials ADD COLUMN IF NOT EXISTS vector_id VARCHAR(100);
ALTER TABLE study_materials ADD COLUMN IF NOT EXISTS class_id INTEGER REFERENCES classes(id) ON DELETE CASCADE;
