          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-semibold text-gray-900">Transcription Status</h3>
              ...
              {currentJob.status === 'processing' && (
                <div className="mt-4">
                  ...
                  <p className="text-xs text-gray-500 mt-2">Processing... This may take a minute.</p>
                </div>
              )}
            </div>
            ...
            {currentJob.transcript && (
              <div className="space-y-4">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4 max-h-96 overflow-y-auto">
                  <p className="text-gray-800 whitespace-pre-wrap">{currentJob.transcript}</p>
                </div>
              </div>
            )}
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 focus:outline-none font-medium"
            >
              ✨ New Transcription
            </button>
          </div>
